...
stats = net.train(X, y, X, y,
                  ...
                  num_iters=100, batch_size=2, verbose=True)
...
stats = net.train(X_train, y_train, X_val, y_val,
                  num_iters=20000, batch_size=256,
...
best_param = {}
old_acc = None
for batch_size, lr, lrdecay, reg in [(32, 0.001, 0.99, 0.1), (64, 0.0001, 0.99, 0.5), (64, 0.0001, 0.99, 0.25),
                                     (64, 0.0001, 0.99, 0.1), (128, 0.0001, 0.99, 0.5), (128, 0.0001, 0.99, 0.25),
                                     (128, 0.0001, 0.99, 0.1), (256, 0.0001, 0.99, 0.5), (256, 0.0001, 0.99, 0.25),
                                     (256, 0.0001, 0.99, 0.1), (32, 0.0001, 0.99, 0.5), (32, 0.0001, 0.99, 0.25),
                                     (32, 0.0001, 0.99, 0.1), (256, 1e-05, 0.99, 0.5), (256, 1e-05, 0.99, 0.25),
                                     (256, 1e-05, 0.99, 0.1)
                                     ]:
